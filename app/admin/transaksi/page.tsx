...
import { FaPlus, FaMinus, FaUserTie } from "react-icons/fa";
  ...
  return (
    <>
      ...
      <nav className="flex flex-col pt-4 px-4 justify-between">
        <Link
          href="transaksi"
          className="mx-auto my-12 p-2 rounded-md bg-blue-200"
        >
          <IoCashOutline className="size-5 text-blue-600"></IoCashOutline>
        </Link>
