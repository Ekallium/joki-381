  ...
  return (
    <aside className="bg-white text-white hidden md:block w-16 fixed top-0 left-0 h-full z-30 border-r-2  border-gray-300">
      <nav className="flex flex-col pt-4 px-4 justify-between">
        ...
        >
          <BiSolidDiscount className="size-5 text-gray-600  "></BiSolidDiscount>
        </Link>
        <Link href="profil" className="mx-auto p-2 mb-12 rounded-md bg-blue-200">
          <PiNotePencilFill className="text-blue-600 size-5"></PiNotePencilFill>
        </Link>
      </nav>
    </aside>
  );
};
export default AdminProfilNav;
