  ...
  return (
    <aside className="bg-white text-white hidden md:block w-16 fixed top-0 left-0 h-full z-30 border-r-2  border-gray-300">
      <nav className="flex flex-col pt-4 px-4 justify-between">
        ...
        <Link href="laporan" className="mx-auto p-2 mb-12 rounded-md bg-blue-200">
          <HiOutlineDocumentText className=" text-blue-600 size-5"></HiOutlineDocumentText>
        </Link>
        <Link href="karyawan" className="mx-auto p-2 mb-12 rounded-md">
          <FaUserTie className="text-gray-600 size-5"></FaUserTie>
        </Link>
        <Link href="diskon" className="mx-auto p-2 mb-12 rounded-md">
          <BiSolidDiscount className="text-gray-600 size-5"></BiSolidDiscount>
        </Link>
...
export default AdminLaporanNav;
